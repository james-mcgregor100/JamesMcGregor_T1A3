def litandphilosophy
        ...
        answer = $prompt.select(question1, choices, echo: false)
    ...
    if answer == choices[0]
        ...
        answer = $prompt.select(question2, choices)
    ...
    if answer == choices[3]
        ...
        answer = $prompt.select(question3, choices)
    ...
    if answer == choices[1]
        ...
        answer = $prompt.select(question4, choices)
    ...
    if answer == choices[3]
        ...
        answer = $prompt.select(question5, choices)
    ...
    if answer == choices[1]
        ...
        answer = $prompt.select(question6, choices)
    ...
    if  answer == choices[1]
        ...
        answer = $prompt.select(question7, choices)
